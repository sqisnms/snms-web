import { IncidentLogType, IncidentLogTypeKor } from "@/types/incident"
import { Button, Dialog, DialogActions, DialogContent, DialogTitle, TextField } from "@mui/material"

type IncidentPopupProps = {
  incident: Partial<IncidentLogType>
  open: boolean
  handleClose: () => void
}

export function IncidentPopup({ incident, open, handleClose }: IncidentPopupProps) {
  return (
